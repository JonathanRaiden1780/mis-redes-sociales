# Angular + Supabase Hardening Patterns (Finanzeasy 2026-08-18)

## Angular Testing Gotchas

### Standalone Component Test Setup
```typescript
// BAD: declarations array rejects standalone components
TestBed.configureTestingModule({
  declarations: [HeaderComponent],  // ERROR: "marked as standalone and can't be declared"
